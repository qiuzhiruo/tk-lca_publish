...
class StdCheck():
    def __init__(self, dialog):
        self.dialog = dialog
        self.check_name = u"检查资产的 asm master 节点。"
    ...
    def run_check(self):
        ...
        try:
            ...
            asset = self.dialog.sg.find_one('Asset', [['id', 'is', self.dialog.entity['id']]],
                                            ['sg_asset_type', 'sg_manual_lod','parents'])
            ...
            self.dialog.d_assets_info[self.dialog.entity['name']] = {'node': pm.PyNode('|master'),
                                                                     ...
                                                                     'version_dir': self.dialog.version_dir,
                                                                     'tank_file': self.dialog.publish_root + '/' + self.dialog.version_name + '/' +
                                                                                  self.dialog.entity['name'] + '.ma',
            ...
            print 'self.dialog.d_assets_info : ',self.dialog.d_assets_info
