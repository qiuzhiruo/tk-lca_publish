...
class StdProcess():
    ...
    def __init__(self, dialog):
        self.dialog = dialog
        self.process_name = u"Profiling Body Rigging Performance 并写出到publish路径。"
        self.description = u"Profiling Body Rigging Performance 并写出到publish路径！"
        return
    ...
    def proceed(self):
        ...
        try:
            ...
            if cmds.objExists('global_ctrl'):
                cs=cmds.listRelatives('global_ctrl',p=1,pa=1)[0]
