...
# hdlr = logging.FileHandler('/mnt/work/home/zhixiang/Desktop/xgenex.log')
...
class StdProcess():
    ...
    #----------------------------fix xgen  things ------------------------
            ...
            # Copy associated maya work file, if it exists
            maya_path =  self.dialog.work_root + '/' + self.dialog.version_name + '.ma'
            if os.path.isfile(maya_path):
                shutil.copyfile(maya_path, self.dialog.version_dir +'/' + self.dialog.version_name + '.ma')
