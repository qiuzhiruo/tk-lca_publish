...
tool_srf_path='{}/python/tk_lca_publish/depts/mod_sg'.format(os.getenv('LCA_PUBLISH_APP'))
#tool_srf_path='/home/huazhuo/tk-lca-publish/python/tk_lca_publish/python/tk_lca_publish/depts/mod_sg'
...
try:
    ...
    from ....ui.widget_file_mod_sg import Ui_Form as widget_publish_file
except:
...
class AppDialog(PublishDialog):
    ...
    def __init__(self, app):
        ...
        try:
            ...
            self.ui.comboBox_publish_mode.removeItem(1)
