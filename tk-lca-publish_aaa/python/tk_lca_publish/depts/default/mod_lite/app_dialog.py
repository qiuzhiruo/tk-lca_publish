    ...
    def __init__(self, app):
        try:
            ...
            self.setup_gui(Ui_Dialog, widget_sys, widget_version, widget_file, widget_check, widget_publish,
                           widget_publish_file)
            self.w_publish_file.pushButton_speed_tree.setEnabled(False)
            self.w_publish_file.pushButton_zb.setEnabled(False)
            self.w_publish_file.pushButton_zb_view.setEnabled(False)
            self.w_publish_file.pushButton_dy.setEnabled(False)
            self.w_publish_file.pushButton_dy_export.setEnabled(False)

            self.w_publish_file.listWidget_zb_view.setEnabled(False)
            self.w_publish_file.listWidget_zb.setEnabled(False)
            self.w_publish_file.listWidget_speed_tree.setEnabled(False)
            self.w_publish_file.listWidget_dy.setEnabled(False)
