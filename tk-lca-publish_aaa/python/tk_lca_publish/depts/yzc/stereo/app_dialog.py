    ...
    def __init__(self, app):
        ...
        try:
            ...
            try:
                ...
                previz = os.path.dirname(scene_path) + '/data/' + os.path.basename(scene_path)[:-3] + '.stereo.mov'

                if not os.path.isfile(previz):
                    previz = ''
                ...
                self.w_publish.plainTextEdit_description.setPlainText( 'stereo adjustment' )

                try:
                    global stereo_publish_dialog
                    stereo_publish_dialog = self
                except:
                    pass
            except:
                print traceback.format_exc()
