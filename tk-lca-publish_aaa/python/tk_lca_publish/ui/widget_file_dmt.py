...
# Form implementation generated from reading ui file 'D:/liulu/sgtk/tk-lca-publish/resources/widget_file_dmt.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox_preview_files.setGeometry(QtCore.QRect(10, 350, 680, 141))
        ...
        self.checkBox_expand_preview = QtGui.QCheckBox(self.groupBox_preview_files)
        self.checkBox_expand_preview.setObjectName(_fromUtf8("checkBox_expand_preview"))
        self.checkBox_expand_preview.setGeometry(QtCore.QRect(110, 117, 151, 21))
        self.checkBox_expand_preview.setChecked(True)
        self.groupBox_publish_files = QtGui.QGroupBox(Form)
        self.groupBox_publish_files.setGeometry(QtCore.QRect(10, 40, 680, 280))
    ...
    def retranslateUi(self, Form):
        ...
        self.checkBox_expand_preview.setText(_translate("Form", "Select Sequences", None))
