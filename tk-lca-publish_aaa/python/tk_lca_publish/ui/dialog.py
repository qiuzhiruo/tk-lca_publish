...
#
# Created: Wed Aug 24 11:56:32 2016
...
""))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox_publish_mode.setItemText(0, _translate("Dialog", "Daily (交预览)", None))
        self.comboBox_publish_mode.setItemText(1, _translate("Dialog", "Downstream (交下游)", None))
